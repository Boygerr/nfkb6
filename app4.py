...
nfkb_inhib = st.sidebar.slider(
    "NF-κB Phosphorylation Inhibitor (blocks nuclear entry)", 0.0, 1.0, 0.0
)

ikba_inhib = st.sidebar.slider(
    "IκBα Phosphorylation Inhibitor (blocks IκB degradation)", 0.0, 1.0, 0.0
)
...
ax.plot(sol.t, sol.y[2], label="IκBα")
ax.plot(sol.t, sol.y[3], label="TNF Gene Expression")
